...
PIE_LEGAL = ("Derechos reservados — I.E.P. ALTERNATIVO YACHAY · "
             "Material de apoyo basado en el temario oficial CEPRU-UNSAAC")
...
def _estilos():
    ...
    return {
        ...
        "n": ParagraphStyle("n", parent=ss["Normal"], fontSize=8.4,
                            leading=15, alignment=TA_JUSTIFY, spaceAfter=3),
        "cel": ParagraphStyle("c", parent=ss["Normal"], fontSize=7.6,
                              leading=11),
...
def _banda_titulo(story, tema, subtitulo, est, ancho, con_claves=False):
    """Cabecera institucional con banda de color y datos del documento."""
...
def _pie(canvas, doc):
    ...
    canvas.drawCentredString(doc.pagesize[0] / 2, 0.7 * cm, PIE_LEGAL)

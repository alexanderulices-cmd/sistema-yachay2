...
PAUSA_MODELOS = [
    {
        ...
        "pasos": [
            ...
            ("🙆", "Estira los brazos al frente — entrelaza los dedos — empuja", 10),
            ("🔄", "Rotacion de muñecas — 5 veces cada mano — adelante y atras", 10),
            ("💃", "Sacude TODO el cuerpo 8 segundos — suelta toda la tension!", 8),
        
            ("🌅", "El AMANECER — abre los brazos como el sol que sale", 10),
            ("🦵", "Patada de estiramiento — extiende la pierna bajo el escritorio", 12),
            ("🤲", "Estira los dedos — abre y cierra las manos 10 veces", 10),
            ("🙆", "Arco hacia atras — empuja el pecho hacia adelante suave", 12),
            ("🌟", "Pose de PODER — pies firmes, brazos en la cintura, sonrie!", 8),
        ]
    },
    {
        "id": 2,
        ...
        "pasos": [
            ("👐", "APLAUDE 10 veces rapido — calentando las manos!", 8),
            ("🦵", "RODILLAS al pecho alternando — izquierda derecha x15 rapido", 12),
            ("💪", "PUNO derecha arriba — baja — izquierda arriba — baja — x10", 10),
            ("🤜", "BOXEO en el aire — 20 golpes rapidos con ganas!", 12),
            ("🦘", "SALTOS en el lugar — 10 saltos energicos con brazos arriba", 12),
            ("🔄", "GIRO de cabeza — lento derecha — lento izquierda — x3 cada", 10),
            ("👋", "SACUDE los brazos — como si quitaras agua — 10 segundos", 8),
            ("🦶", "TALONES al fondo — corre en el lugar levantando talones x15", 12),
            ("🙌", "APLAUDE en distintas posiciones — arriba — abajo — izquierda — derecha", 10),
            ("🌬️", "RESPIRA profundo 3 veces — inhala rapido — exhala lento", 12),
        
            ("🏃", "Trota en el lugar — 20 pasos levantando rodillas", 15),
            ("🦶", "Talones al trasero — alterna 10 veces rapido", 12),
            ("👊", "Golpe cruzado — derecha al frente, izquierda al frente x10", 12),
            ("🫀", "Siente el corazon latir — mano en el pecho — has trabajado bien", 10),
            ("🌬️", "Respira recuperandote — 3 respiraciones profundas lentas", 12),
        ]
    },
    {
        "id": 3,
        ...
        "pasos": [
            ...
            ("🧠", "Cierra los ojos — visualiza un lugar tranquilo que amas", 15),
            ("🌈", "Imagina colores: AZUL calma — VERDE naturaleza — DORADO energia", 12),
            ("🤲", "Pon las manos en el corazon — siente tu latido", 10),
            ("💆", "Relaja la frente — los ojos — la mandibula — los hombros", 12),
            ("✨", "Cuenta regresiva: 5-4-3-2-1 — al 1 abre los ojos lentamente", 8),
            ("😊", "Sonrie — estas en calma — listo para lo que venga", 8),
        
            ("🫀", "Respiracion del CORAZON — siente cada latido 10 seg", 12),
            ("🌊", "OLA de relajacion — recorre tu cuerpo de cabeza a pies", 15),
            ("🧘", "Postura de LOTO mental — espalda recta, manos en las rodillas", 10),
            ("💭", "Pensamiento positivo — visualiza una meta que quieres lograr", 15),
            ("✨", "Agradecimiento — di mentalmente gracias por este momento", 10),
        ]
    },
    {
        "id": 4,
    ...
    },
    {
        ...
        "pasos": [
            ("🌱", "Eres una SEMILLA — enroscate pequeño en tu silla", 8),
            ("🌿", "CRECE lentamente — estira brazos y piernas al cielo", 12),
            ("🌳", "Eres un ARBOL FUERTE — balancea tus ramas con el viento", 12),
            ("🌻", "El SOL te da energia — abre bien los brazos y sonrie", 10),
            ("🦋", "Una MARIPOSA vuela — abre y cierra los brazos suave", 10),
            ("🌧️", "Cae la LLUVIA — mueve los dedos rapido hacia abajo", 8),
            ("🌈", "Sale el ARCOIRIS — dibujalo en el aire con ambos brazos", 10),
            ("🐦", "Un PAJARO canta — estira el cuello y mira arriba", 8),
            ("🍃", "Una BRISA te mueve — ondula todo el cuerpo suavemente", 10),
            ("🌟", "Eres parte de la naturaleza — abraza el aire a tu alrededor", 8),
        ]
    },

    # ══════════════════════════════════════════════════════════════
    # ESTILO FINLANDIA — Bienestar, naturaleza, pausas mentales
    # ══════════════════════════════════════════════════════════════
    {
        "id": 21,
        "nombre": "🇫🇮 Momento Finlandes",
        "nivel": ["TODOS"],
        "color_fondo": "#1e3a8a",
        "color_acento": "#bfdbfe",
        "emoji_principal": "❄️",
        "descripcion": "Pausa de bienestar integral estilo finlandes — mente y cuerpo",
        "pasos": [
            ("❄️", "SILENCIO NORDICO — cierra los ojos 10 segundos, solo escucha", 12),
            ("🌲", "EL PINO — parate derecho, brazos pegados al cuerpo, respira", 10),
            ("🌬️", "Inhala el AIRE FRIO imaginario — infla bien los pulmones", 8),
            ("💨", "Exhala todo el aire lentamente como vapor en invierno", 10),
            ("🎿", "ESQUI imaginario — flexiona rodillas y balancea brazos", 12),
            ("🏔️", "CONTEMPLA la montana — gira la cabeza lento de izquierda a derecha", 12),
            ("🫀", "Pon la mano en el corazon — siente tu latido por 10 segundos", 12),
            ("🤝", "COMUNIDAD — saluda con una sonrisa al companero de al lado", 8),
            ("🧊", "FRIO que activa — frota las manos rapido hasta calentarlas", 10),
            ("☀️", "La LUZ regresa — abre los ojos y estira los brazos al techo", 8),
        ]
    },
    {
        "id": 22,
        "nombre": "🌿 Bosque Interior",
        "nivel": ["SECUNDARIA"],
        "color_fondo": "#14532d",
        "color_acento": "#d9f99d",
        "emoji_principal": "🌲",
        "descripcion": "Mindfulness finlandes — conciencia plena en el aula",
        "pasos": [
            ("👣", "Siente tus pies en el suelo — presiona fuerte 5 segundos", 8),
            ("🌿", "Toca tu escritorio — siente la textura 5 segundos", 8),
            ("👂", "Escucha 3 sonidos diferentes del salon ahora mismo", 12),
            ("👃", "Respira profundo — que olor percibes en el ambiente", 8),
            ("👁️", "Mira por la ventana — nombra 5 cosas que ves", 15),
            ("🤲", "Siente el peso de tus manos sobre el escritorio", 10),
            ("💓", "Pon atencion a tu respiracion sin cambiarla — 15 seg", 15),
            ("🧘", "Scan corporal — recorre mentalmente de pies a cabeza", 15),
            ("🌱", "Planta una intencion para esta clase — que quiero lograr hoy", 12),
            ("✨", "Abre los ojos con calma — estas presente y listo", 8),
        ]
    },
    {
        "id": 23,
        ...
        "color_acento": "#fde68a",
        "emoji_principal": "💙",
        "descripcion": "Pausa emocional — conectar con como te sientes hoy",
        "pasos": [
            ("💭", "Como te sientes HOY — pon una mano en el pecho y respira", 10),
            ("😊", "Recuerda algo que te hizo SONREIR esta semana", 10),
            ("🙏", "Di GRACIAS internamente por 3 cosas de tu vida", 12),
            ("💪", "Recuerda un momento en que fuiste MUY VALIENTE", 10),
            ("🤝", "Piensa en alguien que te APOYA — sientelo en el corazon", 10),
            ("🌟", "Cual es tu SUPERPODER — tu talento especial unico", 12),
            ("🧠", "Respira cuando algo te ESTRESA — inhala 4 — exhala 8", 15),
            ("😌", "Suelta lo que no puedes controlar — solo sueltalo", 12),
            ("🌈", "Visualiza como quieres que sea tu dia — pintalo en la mente", 12),
            ("💛", "Enviame amor a mi mismo — mano en el corazon y sonrie", 8),
        ]
    },

    # ══════════════════════════════════════════════════════════════
    # ESTILO SINGAPUR — Disciplina, precision, activacion mental
    # ══════════════════════════════════════════════════════════════
    {
        "id": 24,
        "nombre": "🇸🇬 Activacion Singapur",
        "nivel": ["PRIMARIA","SECUNDARIA"],
        "color_fondo": "#dc2626",
        "color_acento": "#fef9c3",
        "emoji_principal": "🎯",
        "descripcion": "Ejercicios de precision y concentracion — modelo Singapore",
        "pasos": [
            ("🎯", "POSICION BASE — espalda recta, pies en el suelo, manos sobre la mesa", 8),
            ("👁️", "PUNTO DE ENFOQUE — fija la mirada en un punto lejano 10 segundos", 12),
            ("🫀", "RESPIRACION 4-4-4 — inhala 4, retiene 4, exhala 4", 15),
            ("✋", "CONTEO CON DEDOS — cuenta del 1 al 10 tocando cada dedo", 10),
            ("🔄", "ROTACION CUELLO — izquierda, centro, derecha, centro — suave", 12),
            ("💪", "ISOMETRICO — aprieta los musculos de los brazos 5 segundos sin mover", 8),
            ("👀", "EJERCICIO OCULAR — mueve los ojos: arriba, abajo, izquierda, derecha", 12),
            ("🤜", "PALMAS — aplaude 5 veces con precision — cada aplauso cuenta", 8),
            ("🦶", "PRESION PLANTAR — levanta y baja los talones 10 veces lento", 12),
            ("🏁", "LISTO — espalda recta, cabeza alta, sonrisa de quien puede lograrlo", 8),
        ]
    },
    {
        "id": 25,
        "nombre": "🧮 Matematica en Movimiento",
        "nivel": ["PRIMARIA","SECUNDARIA"],
        "color_fondo": "#1e1b4b",
        "color_acento": "#a5b4fc",
        "emoji_principal": "🔢",
        "descripcion": "Activacion mental con numeros y movimiento — estilo Singapur",
        "pasos": [
            ("1️⃣", "Da 1 salto — luego di el numero 1 en voz alta", 8),
            ("✌️", "Levanta 2 dedos con cada mano — y muevelos", 8),
            ("3️⃣", "3 palmadas en el escritorio — ritmo exacto", 8),
            ("🔢", "Cuenta hacia atras de 10 a 1 — con voz", 15),
            ("➕", "Suma con tu cuerpo — 3 saltos + 2 palmas = 5 movimientos", 12),
            ("✖️", "Multiplica — 2 x 3 — haz 6 movimientos alternados", 12),
            ("🎲", "Tu numero de la suerte — muevete esa cantidad de veces", 10),
            ("📐", "Forma un TRIANGULO con tus brazos sobre la cabeza", 8),
            ("⭕", "Dibuja un CIRCULO GRANDE en el aire con ambos brazos juntos", 10),
            ("🏆", "Levanta ambos brazos — LOGRO DESBLOQUEADO — eres genial!", 8),
        ]
    },

    # ══════════════════════════════════════════════════════════════
    # ESTILO COREA / JAPON — Disciplina y bienestar colectivo
    # ══════════════════════════════════════════════════════════════
    {
        "id": 26,
        "nombre": "🇯🇵 Kata Express",
        ...
        "color_acento": "#fecdd3",
        "emoji_principal": "🥋",
        "descripcion": "Secuencia de movimientos precisos estilo artes marciales japonesas",
        "pasos": [
            ("🙏", "REI — reverencia de respeto inclinando la cabeza", 8),
            ("🦵", "POSICION — pies separados al ancho de hombros, rodillas semiflexas", 10),
            ("🤜", "BLOQUEO — levanta el antebrazo derecho cruzando el pecho", 8),
            ("👊", "GOLPE DIRECTO derecho — lento y con control x5", 12),
            ("🤛", "GOLPE DIRECTO izquierdo — mismo control x5", 12),
            ("🦵", "RODILLA al pecho — derecha 3 veces, izquierda 3 veces", 15),
            ("🔄", "GIRO — rota 90 grados a la derecha, nueva posicion", 8),
            ("✋", "PAUSA — quieto como estatua 5 segundos — fuerza interior", 8),
            ("💨", "KIAI — exhala fuerte en un golpe imaginario al aire", 8),
            ("🙏", "REI FINAL — reverencia de cierre — la disciplina fortalece", 8),
        ]
    },
    {
        "id": 27,
        "nombre": "🌸 Hanami — Flores y Calma",
        "nivel": ["TODOS"],
        "color_fondo": "#831843",
        "color_acento": "#fce7f3",
        "emoji_principal": "🌸",
        "descripcion": "Pausa inspirada en el Hanami japones — contemplacion y belleza",
        "pasos": [
            ("🌸", "Imagina que eres un petal de CEREZO cayendo lento del arbol", 12),
            ("🎋", "BAMBU — parate firme, balanceas suave como bambu en el viento", 10),
            ("🍵", "TE VERDE — siente calma, respira aroma imaginario de te", 10),
            ("🌊", "ONDA — mueve los brazos como olas del mar con tus manos", 12),
            ("🦢", "CISNE — estira el cuello largo y digno, manos detras", 10),
            ("🌙", "LUNA — inclina suave hacia atras viendo el techo — calma", 10),
            ("🗻", "MONTE FUJI — firme, tranquilo, inamovible — postura de poder", 12),
            ("🎑", "COSECHA — agachate lento recogiendo frutos imaginarios", 10),
            ("🏮", "LINTERNA — ilumina con tus manos el camino hacia adelante", 8),
            ("🙏", "ARIGATOU — gratitud por este momento de pausa", 8),
        ]
    },

    # ══════════════════════════════════════════════════════════════
    # NUEVAS TENDENCIAS MUNDIALES EN EDUCACION
    # ══════════════════════════════════════════════════════════════
    {
        "id": 28,
        "nombre": "🤖 Robotica Humana",
        "nivel": ["PRIMARIA","SECUNDARIA"],
        "color_fondo": "#1e3a8a",
        "color_acento": "#7dd3fc",
        "emoji_principal": "🤖",
        "descripcion": "Programa tu cuerpo como un robot — coordinacion y diversion",
        "pasos": [
            ("🤖", "ENCENDIDO — haz el sonido del robot encendiendo: BIZZZZ", 8),
            ("⚙️", "CALIBRANDO — gira la cabeza izquierda-derecha 3 veces lento", 10),
            ("🦾", "BRAZO ROBOTICO derecho — sube y baja como maquina x5", 10),
            ("🦿", "PIERNA ROBOTICA — levanta la rodilla derecha 5 veces preciso", 12),
            ("🔄", "GIRO DE 360 — rota el tronco completo como engranaje", 10),
            ("📡", "SENSOR — cierra los ojos y siente el entorno 5 segundos", 8),
            ("💾", "DESCARGA — respira profundo guardando nueva energia", 10),
            ("🛰️", "TRANSMISION — comunicate con el robot de al lado — saludo", 8),
            ("⚡", "TURBO — movimiento rapido x3 segundos — luego PAUSA", 10),
            ("🔋", "RECARGA COMPLETA — abre los ojos, cuerpo listo al 100%", 8),
        ]
    },
    {
        "id": 29,
        "nombre": "🌍 Viaje Mundial",
        "nivel": ["TODOS"],
        "color_fondo": "#064e3b",
        "color_acento": "#6ee7b7",
        "emoji_principal": "✈️",
        "descripcion": "Un viaje por culturas del mundo con sus danzas y tradiciones",
        "pasos": [
            ("🇧🇷", "BRASIL — baila samba moviendo las caderas al ritmo", 12),
            ("🇮🇳", "INDIA — postura de namasté y movimiento de manos elegante", 10),
            ("🇯🇵", "JAPON — reverencia y movimientos de kata lentos", 10),
            ("🇳🇬", "AFRICA — ritmo con palmas y movimiento de pies", 12),
            ("🇲🇽", "MEXICO — zapateado imaginario en el lugar", 10),
            ("🇵🇪", "PERU — danza de la sierra — salto y giro andino", 10),
            ("🇫🇮", "FINLANDIA — quietud y respiracion profunda en la nieve", 12),
            ("🇦🇺", "AUSTRALIA — didgeridoo imaginario — exhala largo y profundo", 10),
            ("🇨🇳", "CHINA — Tai Chi — movimiento lento y fluido de brazos", 12),
            ("✈️", "ATERRIZAJE — de regreso al salon con toda la energia del mundo", 8),
        ]
    },
    {
        "id": 30,
        "nombre": "🎮 Videojuego Real",
        "nivel": ["PRIMARIA","SECUNDARIA"],
        "color_fondo": "#1e1b4b",
        "color_acento": "#818cf8",
        "emoji_principal": "🕹️",
        "descripcion": "Tu cuerpo es el control del videojuego — muevete para ganar",
        "pasos": [
            ("🕹️", "INICIO DE PARTIDA — posicion lista, manos al frente", 8),
            ("⬆️", "FLECHA ARRIBA — salta en el lugar", 8),
            ("⬇️", "FLECHA ABAJO — agachate rapido", 8),
            ("⬅️", "FLECHA IZQUIERDA — paso rapido a la izquierda", 8),
            ("➡️", "FLECHA DERECHA — paso rapido a la derecha", 8),
            ("🅰️", "BOTON A — aplauso fuerte", 6),
            ("🅱️", "BOTON B — salto con los dos pies", 8),
            ("⭐", "ESTRELLA — gira sobre tu lugar y aplaude al terminar", 10),
            ("💥", "COMBO ESPECIAL — secuencia completa: salta+gira+aplaude", 12),
            ("🏆", "NIVEL COMPLETADO — brazos al cielo y celebra tu victoria", 8),
        ]
    },

    # ══════════════════════════════════════════════════════════════════
    # DINÁMICAS GRUPALES — Para toda el aula juntos
    # ══════════════════════════════════════════════════════════════════
    {
        "id": 31,
        ...
        "color_acento": "#ddd6fe",
        "emoji_principal": "🤝",
        "descripcion": "Dinamica grupal de trabajo en equipo y comunicacion",
        "pasos": [
            ("🧍", "TODOS DE PIE — formen un circulo apretado en el salon", 15),
            ("🤲", "Cada uno extiende AMBAS manos al centro del circulo", 10),
            ("🤝", "Toma las manos de DOS personas diferentes — no del lado tuyo", 12),
            ("🔄", "Sin soltar — intenten DESENREDARSE como grupo", 30),
            ("💬", "COMUNICACION — den instrucciones entre ustedes para lograrlo", 20),
            ("🔀", "Pasen por encima o por debajo — creatividad del grupo", 20),
            ("🎯", "El objetivo: formar un CIRCULO sin nudos al final", 30),
            ("🏆", "Si lo lograron — aplaudan juntos! Si no — rianSe y repitan!", 10),
            ("💡", "REFLEXION rapida — como se comunicaron para lograrlo?", 15),
            ("🤗", "Choca esos cinco con quien te ayudo mas!", 8),
        ]
    },
    {
        "id": 32,
        "nombre": "🪑 El Juego de las Sillas",
        "nivel": ["TODOS"],
        "color_fondo": "#dc2626",
        "color_acento": "#fee2e2",
        "emoji_principal": "🪑",
        "descripcion": "Version activa sin perdedores — todos participan siempre",
        "pasos": [
            ("🪑", "Formen un CIRCULO con las sillas mirando hacia afuera", 15),
            ("🎵", "Cuando empiece la musica — CAMINEN alrededor del circulo", 12),
            ("⏸️", "Al parar la musica — SENTARSE en la silla mas cercana", 8),
            ("🔄", "Quita UNA silla — pero el que se quede sin silla BAILA 5 seg!", 10),
            ("💃", "El que bailo se une al JURADO — ayuda a juzgar los mejores bailes", 10),
            ("🎵", "Siguen jugando — cada ronda un baile nuevo", 12),
            ("🕺", "Movimientos requeridos: serpentina — robot — flamenco — macarena", 15),
            ("🏅", "Premio al mejor baile — aplausos del salon entero", 10),
            ("😂", "Todos participan siempre — nadie sale — solo bailan mas!", 10),
            ("🎉", "Gran final — todos bailan juntos 10 segundos sin parar!", 10),
        ]
    },
    {
        "id": 33,
        ...
        "color_acento": "#cffafe",
        "emoji_principal": "🪞",
        "descripcion": "Dinamica de atencion y conexion — uno imita al otro",
        "pasos": [
            ("👫", "FORMEN PAREJAS — mírense frente a frente", 10),
            ("🪞", "Uno es el LIDER — otro es el ESPEJO que lo imita exactamente", 12),
            ("🙆", "Lider: mueve los brazos LENTO — el espejo lo sigue en tiempo real", 15),
            ("🤸", "Lider: cambia de postura — el espejo se adapta instantaneamente", 15),
            ("😁", "Lider: hace una EXPRESION FACIAL rara — el espejo la copia", 12),
            ("🔄", "CAMBIO — ahora el espejo se convierte en lider", 8),
            ("💃", "Nuevo lider: movimientos de BAILE — el espejo lo imita", 15),
            ("🤝", "DESAFIO — los dos se mueven TAN sincronizados que nadie sabe quien lidera", 15),
            ("👏", "Muestren al salon su mejor sincronizacion — todos aplauden", 12),
            ("🤗", "Agradezcan a su pareja — fue un ejercicio de CONFIANZA", 8),
        ]
    },
    {
        "id": 34,
        "nombre": "🏃 Relevos Express",
        "nivel": ["PRIMARIA","SECUNDARIA"],
        "color_fondo": "#16a34a",
        "color_acento": "#dcfce7",
        "emoji_principal": "🏁",
        "descripcion": "Competencia por equipos — activa y divertida dentro del aula",
        "pasos": [
            ("📋", "FORMEN 4 EQUIPOS — filas desde adelante hasta atras del salon", 12),
            ("🎯", "Regla: el ultimo de cada fila pasa AL FRENTE cuando le toque", 10),
            ("👆", "RETO 1 — primero en pararse con brazos al cielo: 1 punto", 12),
            ("🤸", "RETO 2 — equipo hace la ola de atras hacia adelante mas rapido", 15),
            ("🧠", "RETO 3 — equipo grita el nombre de un animal con cada letra del abecedario", 15),
            ("💪", "RETO 4 — todos del equipo hacen 5 sentadillas al mismo tiempo", 12),
            ("🎭", "RETO 5 — equipo imita el sonido de un vehiculo sin usar palabras", 10),
            ("🤜🤛", "RETO FINAL — equipo choca los cinco en cadena lo mas rapido posible", 15),
            ("🏆", "Cuenten los puntos — el equipo ganador recibe aplauso del salon", 10),
            ("🤝", "Todos los equipos se dan la mano — fue una competencia limpia!", 8),
        ]
    },
    {
        "id": 35,
        "nombre": "🎭 Teatro Congelado",
        "nivel": ["PRIMARIA","SECUNDARIA"],
        "color_fondo": "#9333ea",
        "color_acento": "#f3e8ff",
        "emoji_principal": "🧊",
        "descripcion": "Estatuas en movimiento — creatividad y risas garantizadas",
        "pasos": [
            ("🎵", "Con musica TODOS se mueven libremente por el salon", 12),
            ("🧊", "Al gritar FREEZE — todos se CONGELAN en la posicion exacta", 8),
            ("😂", "El docente elige la postura mas chistosa — todos miran", 10),
            ("🎭", "Esa persona NOMBRA su estatua — le da un titulo creativo", 8),
            ("🎵", "Vuelve la musica — todos se mueven de nuevo", 12),
            ("🧊", "FREEZE otra vez — nueva estatua — nuevo titulo creativo", 8),
            ("👯", "VARIANTE — al freeze, dos personas forman UNA estatua juntos", 12),
            ("🏆", "Votacion rapida — cual fue la estatua mas creativa del salon?", 10),
            ("🤣", "Recrean la estatua ganadora todos juntos al mismo tiempo", 10),
            ("🎊", "Aplauso general — ejercitamos el cuerpo Y la creatividad!", 8),
        ]
    },
    {
        "id": 36,
        "nombre": "🌊 La Ola del Salon",
        "nivel": ["TODOS"],
        "color_fondo": "#1e40af",
        "color_acento": "#bfdbfe",
        "emoji_principal": "🌊",
        "descripcion": "Coordinacion grupal — la ola que recorre todo el salon",
        "pasos": [
            ("👐", "Todos SENTADOS — manos en las rodillas — listos", 10),
            ("🌊", "El primero de la izquierda se PARA y levanta los brazos", 8),
            ("⬅️", "La ola viaja — uno por uno — rapido como el mar", 15),
            ("🔄", "Ronda 2 — ahora mas RAPIDO — todos coordinados", 12),
            ("🌊", "OLA DOBLE — va y VUELVE — como marea", 15),
            ("💥", "OLA EXPLOSIVA — todos saltan al mismo tiempo al llegar la ola", 12),
            ("🎯", "RETO SINCRONIZADO — toda la fila del fondo se para a la vez", 12),
            ("⚡", "VELOCIDAD MAXIMA — la ola mas rapida del salon — beat the record", 10),
            ("🤝", "OLA DE AGRADECIMIENTO — de pie uno a uno, se inclinan", 12),
